...
export const FILTER_EQUIPMENT = 38
export const FILTER_HAS_CORRESPONDENT_ANY = 26
export const FILTER_HAS_EQUIPMENT_ANY = 40
export const FILTER_DOES_NOT_HAVE_CORRESPONDENT = 27
export const FILTER_DOES_NOT_HAVE_EQUIPMENT = 39
...
export const FILTER_EQUIPMENT_VIN = 41
...
export const FILTER_RULE_TYPES: FilterRuleType[] = [
  ...
  },
  {
    ...
    {
    id: FILTER_EQUIPMENT,
    filtervar: 'equipment__id',
    isnull_filtervar: 'equipment__isnull',
    datatype: 'equipment',
    multi: false,
  },
  {
    id: FILTER_EQUIPMENT_VIN,
    filtervar: 'equipment__vin',
    isnull_filtervar: 'equipment__isnull',
    datatype: 'equipment',
    multi: false,
  },
  {
    id: FILTER_HAS_EQUIPMENT_ANY,
    filtervar: 'equipment__id__in',
    datatype: 'equipment',
    multi: true,
  },
  {
    id: FILTER_DOES_NOT_HAVE_EQUIPMENT,
    filtervar: 'equipment__id__none',
    datatype: 'equipment',
    multi: true,
  },
  {
