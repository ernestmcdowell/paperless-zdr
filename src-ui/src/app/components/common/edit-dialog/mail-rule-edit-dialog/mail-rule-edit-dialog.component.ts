...
const METADATA_EQUIPMENT_OPTIONS = [
  {
    id: MailMetadataCorrespondentOption.FromNothing,
    name: $localize`Do not assign a equipment`,
  },
  {
    id: MailMetadataCorrespondentOption.FromEmail,
    name: $localize`Use mail address`,
  ...
  {
    id: MailMetadataCorrespondentOption.FromCustom,
    name: $localize`Use equipment selected below`,
  },
]
...
export class MailRuleEditDialogComponent extends EditDialogComponent<MailRule> {
  ...
  getForm(): FormGroup {
    return new FormGroup({
      ...
      assign_equipment_from: new FormControl(
        MailMetadataEquipmentOption.FromNothing
      ),
      assign_correspondent: new FormControl(null),
      assign_equipment: new FormControl(null),
  ...
  get showEquipmentField(): boolean {
    return (
      this.objectForm?.get('assign_equipment_from')?.value ==
      MailMetadataEquipmentOption.FromCustom
    )
  }
