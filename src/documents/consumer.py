...
class Consumer(LoggingMixin):
    ...
    def __init__(self):
        ...
        self.override_equipment_id = None
    ...
    def run_post_consume_script(self, document: Document):
        ...
        script_env["DOCUMENT_EQUIPMENT"] = str(document.equipment)
    ...
    def try_consume_file(
        ...
        self.override_equipment_id = override_equipment_id
        ...
        for workflow in Workflow.objects.filter(enabled=True).order_by("order"):
            ...
            if document_matches_workflow(
                ...
                for action in workflow.actions.all():
                    ...
                    if action.assign_equipment is not None:
                        template_overrides.equipment_id = (
                            action.assign_equipment.pk
                        )
    ...
    def _parse_title_placeholders(self, title: str) -> str:
        ...
        equipment_name = (
            Equipment.objects.get(pk=self.override_equipment_id).name
            if self.override_equipment_id is not None
            else None
        )
        doc_type_name = (
    ...
    def apply_overrides(self, document):
        ...
        if self.override_equipment_id:
            document.equipment = Equipment.objects.get(
                pk=self.override_equipment_id,
            )
