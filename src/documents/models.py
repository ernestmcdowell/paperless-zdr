...
class Equipment(MatchingModel):
    vin_number = models.CharField(max_length=17, unique=True, null=True, blank=True)
    make = models.CharField(max_length=17, unique=True, null=True, blank=True)
    model = models.CharField(max_length=17, unique=True, null=True, blank=True)
    class Meta(MatchingModel.Meta):
...
class SavedViewFilterRule(models.Model):
    RULE_TYPES = [
        ...
        (38, _("equipment is")),
        (39, _("does not have equipment in")),
        (40, _("does not have equipment")),
...
class WorkflowTrigger(models.Model):
    ...
    filter_has_equipment = models.ForeignKey(
        Equipment,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name=_("has this equipment"),
    )
...
class WorkflowAction(models.Model):
    ...
    assign_equipment = models.ForeignKey(
        Equipment,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name=_("assign this equipment"),
    )
