...
def update_document(writer: AsyncWriter, doc: Document):
    ...
    writer.update_document(
        ...
        equipment=doc.equipment.name if doc.equipment else None,
        equipment_id=doc.equipment.id if doc.equipment else None,
        has_equipment=doc.equipment is not None,
...
class DelayedQuery:
    param_map = {
        ...
        "equipment": ("equipment", ["id", "id__in", "id__none", "isnull"]),
